...
public class DragonDialogue : MonoBehaviour
{
    ...
    */
    ...
    void CalmDown()
    {
        dialog0.text = "Pink: LETS KILL THE TINY CUBE ALREADY!\n\nGreen: Calm down. Let us hear what it has to say at least.\n\nBlack: So what it is cube, Speak.";
    ...
    void OfCourse()
    {
        dialog0.text = "Black: Of course, these idiots suck the life out of me, literally. Miss greenie here thinks she's all smart, but she does not posses the tactical mind like I do so I have to figure everything out. Mr Pink is strong but freaks out all the time. He can't control himself and just wants to eat everything.\nSo I'm the only rational one here. I control this operation and no one gives me the respect I deserve.\n\nGreen: Oh please... You would of been killed by some random knight long ago with us.\n\nBlack: SHut, UP!\n\nPink: ME HUNGY";

        dialog1.GetComponentInChildren<Text>().text = "Hey Black, your better than those other heads of yours. I could help you take out the other two to free you!";
        dialog1.onClick.RemoveAllListeners();
